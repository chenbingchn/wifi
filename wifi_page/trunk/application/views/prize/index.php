...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?=config_item('base_url')?>css/prize/style.css">
	</head>
	<body>
		<div id="page_top">
		 ...
		 <div id="page_center">
		 	<div id="center_content">
			 	<div id="prize_list">
			 		...
			 		<p class="prize_title">1. Keuntungan Harian:</p>
			 		<ul class="mobile_list">
				 		<?php foreach($daily_profit as $row): ?>
							<?php echo "<li>".substr_replace($row->mobile, '****', 3, 4)."</li>"; ?>
						<?php endforeach; ?>
			 		</ul>
			 		<p class="prize_title">2. Hadiah Harian:</p>
			 		<ul class="mobile_list">
				 		<?php foreach($daily_prizes as $row): ?>
				 			<?php echo "<li>".substr_replace($row->mobile, '****', 3, 4)."</li>"; ?>
						<?php endforeach; ?>
			 		</ul>
			 		<p class="prize_title">3. Hadiah Utama:</p>
			 		<ul class="mobile_list">
