...
//      $headers['css'][0] = '' . $this->config->base_url() . 'css/lib/bootstrap.min.css';
        ...
        $this->load->vars('activity', $activity);
    ...
    public function discovery() {
        ...
        $footers['js'][0] = '' . $this->config->base_url() . 'js/discovery/find.js';
    ...
    public function eladies() {
         ...
         *
         */
        $headers['js'][0] = 'https://cdnjs.cloudflare.com/ajax/libs/zepto/1.1.6/zepto.min.js';
//      $headers['js'][1] = '' . $this->config->base_url() . 'js/eladies/zepto.min.js';
//
        $headers['css'][0] = '' . $this->config->base_url() . 'css/lib/bootstrap.min.css';
        $headers['css'][0] = '' . $this->config->base_url() . 'css/eladies/eladies.css?v=1.1';

        $headers['title'] = 'Eladies';

        $footers['js'][0] = '' . $this->config->base_url() . 'js/eladies/down.js?v=1.1';
    ...
    public function guidance() {
        ...
        if ($language == 'in_ID' || $language == 'indonesian') {
            $this->load->view('site/guidance_ID');
        } else {
            $this->load->view('site/guidance');
        }
    }
