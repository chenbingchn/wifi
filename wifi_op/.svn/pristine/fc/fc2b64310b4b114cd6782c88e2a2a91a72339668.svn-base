...
//    }
    ...
    public function actionHistory($id) {
        $query = UseridHotspot::find()->joinWith('wifi')->andFilterWhere(['=', 'userid_hotspot.user_id', $id])->orderBy('created_at desc');
     ...
     * @desc 用户获取积分信息
     */
    public function actionGetscorehistory($id='null') {
     ...
     * @desc 用户兑换积分信息
     */
    public function actionSpendscorehistory($id='null') {
