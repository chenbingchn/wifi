...
<!--        <div class="col-md-4">
    ...
    <table class="table table-bordered table-condensed table-striped" >
        ...
        <th class="text-nowrap text-center">用户名称</th>
        <th class="text-nowrap text-center">物理地址</th>
        <th class="text-nowrap text-center">wifi名称</th>
        <th class="text-nowrap text-center">商铺名称</th>
        <th class="text-nowrap text-center">城市</th>
        <!--<td class="text-nowrap">地点</td>-->
        <!--<td class="text-nowrap">类型</td>-->
        <th class="text-nowrap text-center">WiFi类型</th>
        <th class="text-nowrap text-center">审核状态</th>
        <th class="text-nowrap text-center">提交时间</th>
        <th class="text-nowrap text-center">ping值</th>
        <th class="text-nowrap text-center">详细内容</th>
        </thead>
        <?php foreach ($test as $k => $v): ?>
            <tr>
                ...
                <td class="text-center"><?= Html::encode(Account::getUsernameByUserId($v['user_id'])) ?></td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            <div class="row ">
                                ...
                                <div class="row">
                                    <div class="col-md-2 text-center text-justify text-info" style="margin-top:20px;"><?= Html::encode($v['orders']['address']) ?></div>
