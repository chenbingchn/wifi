...
<div class="integral-form">
    ...
    <?= $form->field($model, 'usage')->textInput(['readonly'=>true]) ?>
    
    <?php if($model->id):?>
    <div class="form-group ">
        <label>全部兑换量</label>
        <input type="text" value="<?= Integralrecord::getExchangCountByIntegralId($model->id)?>" class="form-control" disabled="disabled">
    </div>
    <?php endif;?>
    ...
    <?= $form->field($model, 'img_url')->fileInput()->hint('图片大小为330*180'); ?>
