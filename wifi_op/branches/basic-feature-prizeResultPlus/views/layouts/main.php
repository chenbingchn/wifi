    ...
    <body>
        ...
        <div class="wrap">
            ...
            $menuItems = [
                ...
                '<li><a href="' . $_SERVER['PHP_SELF'] . '?r=prize/index">WiFi抽奖</a></li>',
                '<li><a href="' . $_SERVER['PHP_SELF'] . '?r=award/index">WiFi抽奖（手机号码添加）</a></li>',
                '<li><a href="' . $_SERVER['PHP_SELF'] . '?r=awardtype/index">WiFi抽奖（中奖类型添加）</a></li>',
